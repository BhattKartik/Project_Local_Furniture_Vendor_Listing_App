    ...
    <div className="min-h-screen w-full flex justify-center items-center bg-gradient-to-br from-indigo-50 via-blue-50 to-slate-100">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="flex gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 border border-slate-200 bg-slate-50 hover:bg-slate-100 rounded-lg py-2.5 font-medium text-slate-700">
